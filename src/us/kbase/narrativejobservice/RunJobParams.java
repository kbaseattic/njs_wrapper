...
public class RunJobParams {
    ...
    public RunJobParams withRemoteUrl(String remoteUrl) {
        this.remoteUrl = remoteUrl;
        return this;
    }
    ...
    public String toString() {
        return ((((((((((((("RunJobParams"+" [method=")+ method)+", params=")+ params)+", serviceVer=")+ serviceVer)+", rpcContext=")+ rpcContext)+", remoteUrl=")+ remoteUrl)+", additionalProperties=")+ additionalProperties)+"]");
    }
